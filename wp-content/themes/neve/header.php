...
<div class="wrapper">
	...
	<header style="border: 1px solid red" y class="<?php echo esc_attr( $header_classes ); ?>" <?php echo ( neve_is_amp() ) ? 'next-page-hide' : ''; ?> >
...
<!--		</a>-->
	...
	<main id="content" class="neve-main" style="border: 2px solid blue">
