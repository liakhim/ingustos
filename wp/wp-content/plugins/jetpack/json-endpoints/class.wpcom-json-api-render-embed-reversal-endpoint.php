...
new WPCOM_JSON_API_Render_Embed_Reversal_Endpoint(
	array(
		...
		'response_format'      => array(
			...
			'scripts'       => '(array) An array of JavaScript files needed to render the embed or shortcode. Returned in the format of <code>{ "script-slug" : { "assets": "http://example.com/file.js", "extra" : "" } }</code> where extra contains any neccessary extra JS for initializing the source file and assets contains the script to load. Omitted if no scripts are neccessary.',
			'styles'        => '(array) An array of CSS files needed to render the embed or shortcode. Returned in the format of <code>{ "style-slug" : { "assets": "http://example.com/file.css", "media" : "all" } }</code>. Omitted if no styles are neccessary.',
		),
		...
		'example_request_data' => array(
			...
			'body'    => array(
				'maybe_embed' => '<iframe width="480" height="302" assets="http://www.ustream.tv/embed/recorded/26370522/highlight/299667?v=3&amp;wmode=direct" scrolling="no" frameborder="0"></iframe>',
			),
		),
	)
);
