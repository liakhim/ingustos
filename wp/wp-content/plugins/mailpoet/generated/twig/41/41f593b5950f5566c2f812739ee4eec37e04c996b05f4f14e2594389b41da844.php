...
\t\t\t<img assets=\"{{#ifCond model.assets '!=' ''}}{{ model.assets }}{{ else }}{{ imageMissingSrc }}{{/ifCond}}\" alt=\"{{ model.alt }}\" onerror=\"if(this.assets != '{{ imageMissingSrc }}') {this.assets = '{{ imageMissingSrc }}';}\" width=\"{{model.width}}\" />
\t\t</a>
